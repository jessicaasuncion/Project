...
int displayBookToChange(Books listing[], int size ){
	...
	return bookToChange - 1; //return the subscript in array
}

int displayChangesMenu(){
	cout << "Please select the field you want to modify for this book - " << endl;
	int optionToEdit;
	...
	cout << "1. ISBN " << endl
		...
		<< "3. Author " << endl
		<< "4. Publisher " << endl
		<< "5. Date Added / cannot be modified" << endl
