...
/*	searchBook(resultSearchBooks, resultSearchNumBooks, myBooks, numBooks, SearchByAuthor, "John Vu");
	cout << "*************\n";
...
*/
	...
	searchBook(resultSearchBooks, resultSearchNumBooks, myBooks, numBooks, SearchByQuantity, "4");
	cout << "*************\n";
	for (int i = 0; i < resultSearchNumBooks; ++i) {
		cout << resultSearchBooks[i].getIsbn() << "|" << resultSearchBooks[i].getTitle() << "|" << resultSearchBooks[i].getAuthor() << "|" <<
			resultSearchBooks[i].getPublisher() << "|" << resultSearchBooks[i].getDateAdded() << "|" << resultSearchBooks[i].getQuantity() << "|" <<
	...
	resultSearchNumBooks = 0;
	searchBook(resultSearchBooks, resultSearchNumBooks, myBooks, numBooks, SearchByPrice, "16.99");
	cout << "*************\n";
	for (int i = 0; i < resultSearchNumBooks; ++i) {
		cout << resultSearchBooks[i].getIsbn() << "|" << resultSearchBooks[i].getTitle() << "|" << resultSearchBooks[i].getAuthor() << "|" <<
			resultSearchBooks[i].getPublisher() << "|" << resultSearchBooks[i].getDateAdded() << "|" << resultSearchBooks[i].getQuantity() << "|" <<
